...
function getDefaultCourse() {
  return {
    id: POWERBI_COURSE_ID,

    nome:
      "Power BI na Prática",

    descricao:
      "Aprenda Power BI na prática com aulas, dashboards e atividades aplicadas ao dia a dia.",
...
/* =========================================================
   CARREGAR TODA A ESTRUTURA DO POWER BI
========================================================= */

async function loadPowerBICourse() {
  try {
    ...
    */
    ...
    console.error(
      "Erro ao carregar o curso de Power BI:",
      error
    );
...
async function renderCurrentLesson() {
  ...
  if (description) {
    description.textContent =
      ...
      course?.descricao ||
      "Conteúdo prático do curso de Power BI.";
  }
