...
function getDefaultCourse() {
  return {
    id: POWERPOINT_COURSE_ID,

    nome:
      "PowerPoint na Prática",

    descricao:
      "Aprenda PowerPoint na prática com aulas, apresentações e atividades aplicadas ao dia a dia.",
...
/* =========================================================
   CARREGAR TODA A ESTRUTURA DO POWERPOINT
========================================================= */

async function loadPowerPointCourse() {
  try {
    ...
    */
    ...
    console.error(
      "Erro ao carregar o curso de PowerPoint:",
      error
    );
...
async function renderCurrentLesson() {
  ...
  if (description) {
    description.textContent =
      ...
      course?.descricao ||
      "Conteúdo prático do curso de PowerPoint.";
  }
